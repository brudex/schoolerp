...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/employee/leave/request/form.vue?vue&type=template&id=772030ee&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/employee/leave/request/form.vue?vue&type=template&id=772030ee& ***!
  \*************************************************************************************************************************************************************************************************************************/
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-12 col-sm-6" }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-body border-right p-4" }, [
          _c(
            "form",
            {
              on: {
            ...
            [
              _c(
                ...
                { staticClass: "row" },
                [
                  _vm.hasPermission("request-leave-for-other-employee")
                    ? [
                        !_vm.uuid
                                      ...
                                      on: {
                                        change: function($event) {
                                          ...
                                          if (Array.isArray($$a)) {
                                            ...
                                            if ($$el.checked) {
                                              $$i < 0 &&
                                                (_vm.apply_leave_for_other = $$a.concat(
                                                  [$$v]
                                                ))
                                            } else {
                                              $$i > -1 &&
                                                (_vm.apply_leave_for_other = $$a
                                                  .slice(0, $$i)
                                                  .concat($$a.slice($$i + 1)))
                                            }
                                          } else {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(
                                            _vm.trans(
                                              "employee.apply_leave_for_other"
                                            )
                                          )
                                        )
                                      ]
                                    ...
                                    "v-select",
                                    {
                                      ...
                                      on: {
                                        ...
                                        close: function($event) {
                                          return _vm.leaveRequestForm.errors.clear(
                                            "employee_id"
                                          )
                                        },
                          ...
                          ? _c("div", { staticClass: "col-12 col-sm-6" }, [
                              _c("p", { staticClass: "m-t-20" }, [
                                _vm._v(
                                  "\n                                        " +
                                    _vm._s(
                                      _vm.getEmployeeNameWithCode(_vm.employee)
                                    ) +
                                    " "
                                ),
                                _c("br"),
                ...
                _c("div", { staticClass: "col-12 col-sm-6" }, [
                  _c(
                    ...
                    [
                      _c("label", { attrs: { for: "" } }, [
                        _vm._v(
                          _vm._s(_vm.trans("employee.leave_request_start_date"))
                        )
                      ]),
                      _vm._v(" "),
                      _c("datepicker", {
                        attrs: {
                          ...
                          placeholder: _vm.trans(
                            "employee.leave_request_start_date"
                          )
                        },
                        on: {
                ...
                _c("div", { staticClass: "col-12 col-sm-6" }, [
                  _c(
                    ...
                    [
                      _c("label", { attrs: { for: "" } }, [
                        _vm._v(
                          _vm._s(_vm.trans("employee.leave_request_end_date"))
                        )
                      ]),
                      _vm._v(" "),
                      _c("datepicker", {
                        attrs: {
                          bootstrapStyling: true,
                          placeholder: _vm.trans(
                            "employee.leave_request_end_date"
                          )
                        },
                        on: {
                          selected: function($event) {
                ...
                _c("div", { staticClass: "col-12" }, [
                  _c(
                    ...
                    [
                      _c("label", { attrs: { for: "" } }, [
                        _vm._v(
                          _vm._s(_vm.trans("employee.leave_request_reason"))
                        )
                      ]),
                      _vm._v(" "),
                ...
                [
                  _c(
                    "router-link",
                    {
                      ...
                      attrs: { to: "/employee/leave/request" }
                    },
    ...
    _c("div", { staticClass: "col-12 col-sm-6" }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-body" }, [
          ...
          _vm._v(" "),
          _vm.leave_allocations.length
            ? _c("div", { staticClass: "table-responsive" }, [
                _c("table", { staticClass: "table table-sm" }, [
                  _c("thead", [
                    _c("tr", [
                      _c("th", [_vm._v(_vm._s(_vm.trans("employee.name")))]),
                      _vm._v(" "),
                      _c("th", [
                        _vm._v(
                          _vm._s(_vm.trans("employee.leave_allocation_period"))
                        )
                      ]),
                      _vm._v(" "),
                      _c("th", [
                        _vm._v(_vm._s(_vm.trans("employee.leave_allotted")))
                      ])
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                    "tbody",
                    _vm._l(_vm.leave_allocations, function(leave_allocation) {
                      return _c("tr", [
                        _c("td", {
                          domProps: {
                            textContent: _vm._s(
                        ...
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              _vm._f("moment")(leave_allocation.start_date)
                            ) +
                              " " +
                              _vm._s(_vm.trans("general.to")) +
                              " " +
                              _vm._s(
                                _vm._f("moment")(leave_allocation.end_date)
                              )
                          )
                        ]),
                        _vm._v(" "),
                            ...
                            _vm._l(
                              ...
                              function(leave_allocation_detail) {
                                return _c("li", [
                                  _vm._v(
                                    _vm._s(
                                      leave_allocation_detail.leave_type.name +
                                        ": " +
            ...
            : _c("div", [
                _c("p", { staticClass: "alert alert-danger m-2" }, [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_form_vue_vue_type_template_id_772030ee___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./form.vue?vue&type=template&id=772030ee& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/employee/leave/request/form.vue?vue&type=template&id=772030ee&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_form_vue_vue_type_template_id_772030ee___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_form_vue_vue_type_template_id_772030ee___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
//# sourceMappingURL=edit.js.map?id=5d44667ccf3dafd167f1