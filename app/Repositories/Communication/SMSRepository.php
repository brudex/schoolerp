...
class SMSRepository
{
    ...
    public function getStudentNumber($params = array())
    {
        ...
        $student_records = $this->student_record->select(['id','student_id'])->with(['student:id,student_parent_id,contact_number,emergency_contact_number','student.parent:id,first_guardian_contact_number_1,first_guardian_contact_number_2,second_guardian_contact_number_1,second_guardian_contact_number_2'])->whereIn('id', $total_student_record_ids)->get();
    ...
    public function getEmployeeNumber($params = array())
    {
        ...
        $employees = $this->employee->whereIn('id', $total_employee_ids)->select(['id','contact_number','alternate_contact_number','emergency_contact_number'])->get();
